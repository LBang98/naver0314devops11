...
<div class="a">
    ...
    <c:if test="${sessionScope.loginok != null}">
        <div class="guestformarea" style="width: 400px; left: 130px; position: relative">
            <textarea style="width: 100%; height: 120px;" id="gcontent"></textarea>
            <br>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="${stpath}/" class="largephoto" style="max-width: 100%;">
                </div>
