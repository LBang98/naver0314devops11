...
public class Ex8_MemberList {
    ...
    static final String FILENAME = "/Users/ibyeonghyeon/Desktop/naver0314/memeber.txt";

    public Ex8_MemberList(){
        memberReadFile();

    }
    //파일 읽기 - 처음 생성 시 자동으로 파일에서 멤버 가져오기
    ...
    public void memberFileSave(){
        ...
        try {
            ...
            try {
                fw.close();
            } catch (IOException | NumberFormatException e) {   //두가지 Exception 을 같이 처리하고자 할 경우
                throw new RuntimeException(e);
            }
        }
    ...
    public void deleteMember(){
        ...
        * */
        ...
        System.out.println("삭제 할 이름을 입력");
        String name = sc.nextLine();
        ...
        * */
        ...
        for(int i=0; i< list.size(); i++){
            ...
            if(dto.getName().startsWith(name)){
                ...
                System.out.println("혈액형: " + dto.getBlood() + "형");
                System.out.println("-".repeat(40));
            }
        }
        if(!f)
    ...
    public void searchPhone(){
        ...
        /*
         *   검색할 핸드폰 끝 4자리 입력하면 그 번호를 가진 사람 출력 (endsWith)
         *   한명도 없을 경우 "xxxx 번호를 가진 멤버는 없습니다"
         *
         *   이름 : xxx
         *   핸드폰 : xxx
         *   주소 : xxx
         ...
         * */
        boolean f = false;
        System.out.println("핸드폰 끝 4자리 입력");
        String hp = sc.nextLine();
