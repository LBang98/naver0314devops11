...
<div style="margin: 20px; width: 400px">
    <form action="memoaction.jsp" method="post"enctype="multipart/form-data">
        <table class="table table-bordered">
            ...
            <tr>
                <td colspan="2">
                    <textarea style="width: 100%; height: 100px;" name="content" class="form-control" required></textarea>
                </td>
            </tr>
            <tr>
    ...
    <img id="showimg" src="" onerror="this.src = '../image/talent/noimage2.gif'"> <!--  미리보기용   -->
</div>
</body>
</html>
