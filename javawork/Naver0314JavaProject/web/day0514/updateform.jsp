...
<head>
    ...
    <script type="text/javascript">
        $(function (){
            //첫 아바타는 인덱스가 0번이므로 실제 avata값에서 1을 뺀 후 클래스 적용
    ...
    <form action="./update" method="post">
        ...
        <table class="table table-bordered" style="width: 400px;">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control" name="writer" required value="${dto.writer}">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" align="center">
                    <button type="submit" class="btn btn-sm btn-outline-success">게시글수정</button>
