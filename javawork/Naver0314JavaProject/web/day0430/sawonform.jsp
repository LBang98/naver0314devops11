    ...
    <form action="./sawoninsert.jsp" method="post">
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td>
                    <input type="number" min="1" max="100" step="1" value="0" name="age" class="form-control" required>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="2" align="center">
                    <button type="submit" class="btn btn-outline-secondary ben-sm" style="width: 80px">사원저장</button>
                    <button type="button" class="btn btn-outline-secondary ben-sm" style="width: 80px"
