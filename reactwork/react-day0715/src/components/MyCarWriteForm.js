...
const MyCarWriteForm = ({onSave}) => {
    ...
    const photopath="https://kr.object.ncloudstorage.com/bitcamp-bh-98/mycar";//스토리지 주소
    ...
    return (
        <div>
            <Alert color='error' style={{width:'500px'}}>
                자동차 등록하기</Alert>
