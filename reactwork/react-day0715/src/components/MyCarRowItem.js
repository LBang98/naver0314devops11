...
const MyCarRowItem = ({idx,row,onDelete,onUpdate}) => {
    ...
    const photopath1="https://q9h1r9bh3709.edge.naverncp.com/s2TlqaXAZo/mycar";
    const photopath2="?type=f&w=40&h=40&faceopt=true&ttype=jpg";
    const storagepath="https://kr.object.ncloudstorage.com/bitcamp-bucket-56/mycar";//스토리지 주소
